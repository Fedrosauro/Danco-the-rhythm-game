...
public class HTPPanel extends JPanel implements MouseListener, MouseMotionListener, ActionListener {
    ...
    private BufferedImage background, goBack_h, goBack_nh;
    ...
    public void setup(){
        ...
        background = loader.loadImage("res/images/backgrounds/background_howtoPlay.png");
